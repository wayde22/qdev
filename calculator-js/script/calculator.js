...
function numButtonClick(numButton){
...
document.getElementById("zero").addEventListener('click', () => numButtonClick("0"));
document.getElementById("one").addEventListener('click', () => numButtonClick("1"));
document.getElementById("two"). addEventListener('click', () => numButtonClick("2"));
document.getElementById("three").addEventListener('click', () => numButtonClick("3"));
document.getElementById("four").addEventListener('click', () => numButtonClick("4"));
document.getElementById("five").addEventListener('click', () => numButtonClick("5"));
document.getElementById("six").addEventListener('click', () => numButtonClick("6"));
document.getElementById("seven").addEventListener('click', () => numButtonClick("7"));
document.getElementById("eight").addEventListener('click', () => numButtonClick("8"));
document.getElementById("nine").addEventListener('click', () => numButtonClick("9"));
...
function(){
    ...
    else if (!a.includes(".") && a.length<=10){
        a=a+"."};
    document.getElementById("screen").innerText = a;});
...
document.getElementById("minus").addEventListener('click', function(){
    ...
    if (!numArray[0] && recentOperator == false && a!=""){
        numArray.push(Number(a));
    };
    operator = "minus";
    a = "";
